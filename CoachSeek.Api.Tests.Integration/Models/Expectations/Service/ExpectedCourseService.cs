namespace CoachSeek.Api.Tests.Integration.Models.Expectations.Service
{
    public abstract class ExpectedCourseService : ExpectedService
    {
        ...
        protected ExpectedCourseService(string name, 
                                        string colour,
                                        int sessionCount,
                                        string repeatFrequency,
                                        int? duration = null,
                                        ...
                                        int? studentCapacity = null,
                                        bool? isOnlineBookable = null)
            : base(name, colour, sessionCount, repeatFrequency, duration, sessionPrice, coursePrice, studentCapacity, isOnlineBookable)
        { }
    }
}
