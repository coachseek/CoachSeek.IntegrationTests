...
namespace CoachSeek.Api.Tests.Integration.Models.Expectations.Session
{
    public abstract class ExpectedSingleSession
    {
        ...
        protected ExpectedSingleSession(Guid coachId, Guid locationId, Guid serviceId, string date, string startTime, int duration, int studentCapacity, bool isOnlineBookable, decimal? price, string colour)
        {
